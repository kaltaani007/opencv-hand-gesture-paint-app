...
class handDetector():
    ...
    def __init__(self,static_image_mode=False,
               ...
               min_tracking_confidence=0.5):#constructor
        ...
        self.hands=self.mpHands.Hands(self.image_mode,
               self.max_num_hands ,
               self.model_complexity ,
               self.min_detection_confidence ,
               self.min_tracking_confidence ) #object for Hands for a particular instance
